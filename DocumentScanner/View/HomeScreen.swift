...
struct HomeScreen: View {
    ...
    @Query(sort: [.init(\Document.createdAt, order: .reverse)], animation: snappy) private var documents: [Document]
    ...
    var body: some View {
        NavigationStack {
            ScrollView(.vertical) {
                LazyVGrid(columns: Array(repeating: GridItem(spacing: 8), count: 2), spacing: 16) {
